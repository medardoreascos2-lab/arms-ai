...
def receive_market_webhook(
    ...
    service = LiveMarketAnalysisService(
        ...
        smart_money_engine_v2=getattr(
            request.app.state,
            "smart_money_engine_v2",
            None,
        ),
        market_regime_engine=getattr(
            request.app.state,
            "market_regime_engine",
            None,
        ),
        confluence_engine_v2=getattr(
            request.app.state,
            "confluence_engine_v2",
            None,
        ),
        probability_engine_v2=getattr(
            request.app.state,
            "probability_engine_v2",
            None,
        ),
        execution_decision_engine_v2=getattr(
            request.app.state,
            "execution_decision_engine_v2",
            None,
        ),
        decision_council_v2=getattr(
            request.app.state,
            "decision_council_v2",
            None,
        ),
        multi_timeframe_decision_engine_v2=getattr(
            request.app.state,
            "multi_timeframe_decision_engine_v2",
            None,
        ),
        market_context_engine_v2=getattr(
            request.app.state,
            "market_context_engine_v2",
            None,
        ),
        trade_planner_v2=getattr(
            request.app.state,
            "trade_planner_v2",
            None,
        ),
        trade_validator_v2=getattr(
            request.app.state,
            "trade_validator_v2",
            None,
        ),
        signal_generator_v2=getattr(
            request.app.state,
            "signal_generator_v2",
            None,
        ),
        execution_manager_v2=getattr(
            request.app.state,
            "execution_manager_v2",
            None,
        ),
        paper_execution_engine_v2=getattr(
            request.app.state,
